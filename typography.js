module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      ...
      '--tw-prose-links-hover': theme('colors.green'),
      '--tw-prose-links-underline': theme('colors.green / 0.3'),
      '--tw-prose-bold': theme('colors.dark'),
      '--tw-prose-counters': theme('colors.dark'),
      '--tw-prose-bullets': theme('colors.light'),
      '--tw-prose-hr': theme('colors.dark / 0.05'),
      ...
      '--tw-prose-invert-links-hover': theme('colors.yellow'),
      '--tw-prose-invert-links-underline': theme('colors.yellow / 0.3'),
      ...
      '--tw-prose-invert-hr': theme('colors.light / 0.05'),
      ...
      '--tw-prose-invert-code-bg': theme('colors.dark / 0.15'),
      '--tw-prose-invert-code-ring': theme('colors.light / 0.1'),
