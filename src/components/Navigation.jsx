...
export const navigation = [
  ...
  // },
  {
    ...
    links: [
      { title: 'Overview', href: '/content-management' },
      { title: 'Templates', href: '/content-management/templates' },
      { title: 'Entries', href: '/content-management/entries' },
      { title: 'Widgets', href: '/content-management/widgets' },
      { title: 'Groups', href: '/content-management/groups' },
      { title: 'Media', href: '/content-management/media' },
      { title: 'Settings', href: '/content-management/settings' },
    ],
  },
  {
    title: 'Integrations',
