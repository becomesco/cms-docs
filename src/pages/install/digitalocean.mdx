...
<Image src={selectADroplet} alt="" unoptimized />
...
<Image src={chooseAPlan} alt="" unoptimized />
...
<Image src={chooseADatacenter} alt="" unoptimized />
...
<Image src={inboundRules} alt="" unoptimized />

Outgoing connection rules can be left without changing them, as shown below.

<Image src={outboundRules} alt="" unoptimized />
...
<Image src={applyToDroplets} alt="" unoptimized />
...
<Image src={firewalls} alt="" unoptimized />
...
<Image src={publicIpAddressOfTheDroplet} alt="" unoptimized />
...
<Image src={executeSshCommand} alt="" unoptimized />
...
<Image src={ubuntuServerLoginMessage} alt="" unoptimized />
...
<Image src={openInstanceInstallInstructions} alt="" unoptimized />
