...
these [predefined BCMS event scopes](https://github.com/bcms/cms-backend/blob/master/src/types/event/config.ts#L4) or name of a custom event scope.
- Method - Defines which method will trigger the event. Can be one of these [predefined BCMS event methods](https://github.com/bcms/cms-backend/blob/master/src/types/event/config.ts#L21).
...
More information [here](https://github.com/bcms/cms-backend/blob/master/src/types/event/main.ts#L9)
