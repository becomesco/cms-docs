...
HTTP request to the BCMS backend API. Once function is created, it will be
...
authorization.
- Global scope - Is the place where you want to do your imports declare
utility functions.
...
To edit function, click on **Edit** button.
...
When you are on the Instance screen click on **Functions** card. Here you will
see the list of all functions with a function name and **Edit** button next to it.
To delete function, click on **Edit** button and after that click on **Delete**
