...
log in to the [BCMS Cloud](https://app.thebcms.com) and open the instance you would like to add a function to.
...
accessible to anyone while private function will require [API Key](/inside-bcms/api-manager)
authorization.
...
More information [here](https://github.com/bcms/backend/blob/master/src/types/function/models/main.ts#L37)
