...
In the example above, we quickly created an endpoint that returns a light model of all templates from the BCMS instance, containing only the _title_ and _slug_ properties of each template.
