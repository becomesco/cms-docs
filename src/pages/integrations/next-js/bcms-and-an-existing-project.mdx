...
1. Install BCMS plugin and its dependencies by running: `npm i -D next-plugin-bcms @becomes/cms-cli @becomes/cms-client @becomes/cms-most`
...
5. Finally, we will call [BCMS Most](https://github.com/becomesco/cms-most) functions in every script before Next execution.
