...
using [HTTP Signature](https://github.com/bcms/cms-client/blob/master/src/util/security.ts#L6)
which is available out-of-the-box with [BCMS Client package](https://github.com/bcms/cms-client).
