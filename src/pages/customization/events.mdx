...
Only Functions, Jobs, and Plugins can trigger internal events. Events are triggered using the [Event Manager](https://github.com/bcms/cms-backend/blob/master/src/event/main.ts#L12).
A few examples:
