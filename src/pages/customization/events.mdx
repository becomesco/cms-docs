...
They allow you to run some custom code when specific event happens.
...
Only Functions, Jobs, and Plugins can trigger internal events. Events are triggered using the [Event Manager](https://github.com/becomesco/cms-backend/blob/master/src/event/main.ts#L12).
A few examples:
