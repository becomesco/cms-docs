...
You can also give each template a description. It is visible only inside the CMS.
Teams usualy use descriptions to describe internal processes, share resources and explain what that template is being used for.
