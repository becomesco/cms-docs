...
<Note>English is the default language of the BCMS, so you won't be able to delete it. Any other language you can delete, but note that this will remove all data you added for that specific language.</Note>
