...
An entry's structure depends on what properties its template has. Properties defined in its template will be used used in the *meta* section of every entry.
