...
## View where's the Entry used

To view where's the entry used click on the <ThreeDots /> beside the Edit button and click on **Where is used**. This will give you the list of all places where this specifc Entry has been used, such as other entries which are linking to this specific one.
