...
To add properties to your newly created widget, click **Add property**, and select from the list of properties.
...
Deleting a widget is as easy as clicking on the **Delete**, entering the widgets's name and clicking **Confirm**.
