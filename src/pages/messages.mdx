export const description =
  'On this page, dive into the different message endpoints you can use to manage messages programmatically.'

# Messages

Messages are what conversations are made of in Protocol — they are the basic building blocks of your conversations with your Protocol contacts. On this page, dive into the different message endpoints you can use to manage messages programmatically. Look at how to query, send, update, and delete messages. {{ className: 'lead' }}
